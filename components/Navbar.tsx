...
import { Bell, ChevronDown, Home, LogOut, Menu, Plus, Settings, X } from "lucide-react"
            ...
            {navItems.map((item) => (
              <Link
                ...
                className={cn(
                  ...
                  isActive(item.href) ? "text-purple-600" : "text-muted-foreground hover:text-foreground",
                )}
              >
            ...
            <>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="flex items-center gap-2 rounded-full p-1.5 pr-4 hover:bg-accent">
            ...
            >
              <div className="flex items-center justify-between">
                <Link href="/" className="flex items-center gap-2" onClick={() => setMobileMenuOpen(false)}>
                  ...
                  <span className="text-xl font-bold">Ajo for Sol</span>
                </Link>
                <Button
                  variant="ghost"
                  size="icon"
