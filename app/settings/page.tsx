            ...
            <div className="flex flex-col items-center justify-center space-y-3 border-b border-border pb-6">
              <Avatar className="h-20 w-20">
                <AvatarFallback className="bg-purple-100 text-purple-800 text-xl dark:bg-purple-900 dark:text-purple-300">
                  {publicKey ? publicKey.toBase58().slice(0, 2) : "U"}
                </AvatarFallback>
              </Avatar>
              <div className="text-center">
                <h3 className="text-lg font-medium">{publicKey ? publicKey.toBase58().slice(0, 8) : "User"}</h3>
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2">
                  <code className="rounded bg-muted px-2 py-1 text-xs">
                    {publicKey ? `${publicKey.toBase58().slice(0, 12)}...${publicKey.toBase58().slice(-8)}` : "-"}
                  </code>
